...
function Roadmap() {
  ...
  useEffect(() => {
    if (typeof (location.state) !== 'undefined' && location.state !== null) {
      ...
      if (Object.keys(serverLists[0])[0] !== "id") {
        setServerNot(true)
      }
    } else {
      history.push({
  ...
  return (
    <div>
      { serverNot === true ?
        ...
        :
        <div>
          <RoadMapPage readScheduleList={readScheduleList} menubar={menubar} teamMate={teamMate} nickname={nickname} leader={leader} team={lists} accessToken={accessToken}></RoadMapPage>
